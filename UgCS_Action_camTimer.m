function Z = UgCS_Action_camTimer(docNode1,data,seg_order)
...
segments_node.appendChild(action_node);
    ...
    cam_node = docNode1.createElement('cameraSeriesByTimeDefinition');
    action_node.appendChild(cam_node);  
    
        int_node = docNode1.createElement('interval');
        int_node.setAttribute('v',num2str(distance)); 
